...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item">
                <a href="/admin/penilaian/add" class="btn btn-primary btn-tambah-nilai">
    ...
    <div class="section-body">
        <div class="card card-primary">
            <form action="/admin/nilai/update" id="formNilai" class="formNilai" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" required min="1" value="<?= $nilai->semester ?>" name="semester" id="semester" placeholder="Masukan Semester (1,2)" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" value="<?= $nilai->nama ?>" id="nama" readonly class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="kelas" class="form-label">Kelas</label>
                                <input type="text" name="kelas" value="<?= $nilai->kelas ?>" id="kelas" readonly class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="jurusan" class="form-label">Jurusan</label>
                                <input type="text" name="jurusan" value="<?= $nilai->jurusan ?>" id="jurusan" readonly class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <?php foreach ($mapel as $k => $v) : ?>
                                    <?php if (strtolower($v->tipe) == strtolower($value->kategori)) : ?>
                                        <div class="form-group">
                                            ...
                                            <input value="<?= isset($n->{$value->kategori}[$index]) ? $n->{$value->kategori}[$index]->nilai : 0 ?>" type="number" min="0" max="100" required placeholder="Masukan nilai <?= $v->nama ?>" name="nilaiMapel[<?= $v->nama ?>]" id="nilaiMapel_<?= $v->nama ?>" class="form-control mapelku">
                                        </div>
                                        <?php $index++ ?>
                                    <?php endif ?>
                                <?php endforeach ?>
