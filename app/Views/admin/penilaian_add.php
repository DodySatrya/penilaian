...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item">
                <a href="/admin/penilaian" class="btn btn-primary btn-tambah-nilai">
    ...
    <div class="section-body">
        <div class="card card-primary">
            <form action="/admin/nilai/store" id="formNilai" class="formNilai" method="post">
                <div class="card-body">
                    <div class="row">
                    <div class="col-md-6">
                            <div class="input-group">
                            <label for="idSiswa" class="form-label">Semester</label>
