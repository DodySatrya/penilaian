...
<script>
    $(document).ready(function() {
        $(".btn-filter").click(function() {
            ...
            $.ajax({
                url: '/admin/nilai/getBKM/' + kelas + '/' + semester,
                type: 'GET',
                dataType: 'JSON',
                success: function(res) {
                        ...
                        $("#tableNilaiSiswa tbody").append(`
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/admin/nilai/print/${v.id}" class="btn btn-success btn-sm btn-detail"><i class="fas fa-print"></i></a>
                                    <a href="/admin/nilai/detail/${v.id}" class="btn btn-info btn-sm btn-detail"><i class="fa fa-file-alt"></i></a>
                                    <a href="/admin/penilaian/edit/${v.id}" class="btn btn-primary btn-sm btn-edit"><i class="fa fa-edit"></i></a>
                    ...
                    $(".btn-delete").each(function() {
                        $(this).click(function() {
                            ...
                            if (conirm) {
                                $.ajax({
                                    url: '/admin/nilai/delete/' + $(this).data('semester') + "/" + $(this).data('nama'),
                                    type: 'DELETE',
                                    success: function(r) {
                                        window.location.href = "/admin/penilaian";
                                    }
                                });
                            }
                        });
